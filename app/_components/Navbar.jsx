...
const Navbar = () => {
      ...
      <ul className='text-gray-100  flex items-center gap-6 relative nav-menus'>
        ...
        <li className='relative' onClick={marketPageToggle}><a href="#"  className='flex gap-2 items-center text-[20px] main-links'>
          ...
          {marketToggle &&
           ...
           <ul  className='flex flex-col gap-1 '>
             <li><a href="#" className='hover:bg-gray-300 transition duration-300 p-2 rounded-[5px] block  nav-link' onClick={() =>setMarketToggle(false)}>Forex</a></li>
             <li><a hrefLink="#" className='hover:bg-gray-300 transition duration-300 p-2 rounded-[5px] block  nav-link' onClick={() =>setMarketToggle(false)}>Indices</a></li>
             <li><a href="#" className='hover:bg-gray-300 transition duration-300 p-2 rounded-[5px] block  nav-link' onClick={() =>setMarketToggle(false)}>Commodities</a></li>
             <li><a href="#" className='hover:bg-gray-300 transition duration-300 p-2 rounded-[5px] block  nav-link' onClick={() =>setMarketToggle(false)}>Metals</a></li>
             <li><a href="#" className='hover:bg-gray-300 transition duration-300 p-2 rounded-[5px] block  nav-link' onClick={() =>setMarketToggle(false)}>Energy Commodities</a></li>
             <li><a href="#" className='hover:bg-gray-300 transition duration-300 p-2 rounded-[5px] block  nav-link' onClick={() =>setMarketToggle(false)}>Shares</a></li>
             <li><a href="#" className='hover:bg-gray-300 transition duration-300 p-2 rounded-[5px] block  nav-link' onClick={() =>setMarketToggle(false)}>Cryptocurrencies</a></li>
             <li><a href="#" className='hover:bg-gray-300 transition duration-300 p-2 rounded-[5px] block  nav-link' onClick={() =>setMarketToggle(false)} rounded-sm>ETFs</a></li>
           </ul>
          </div>
          }
        ...
        <li onClick={tradingPageToggle}><a href="#"  className='flex gap-2 items-center text-[20px] main-links'>
          ...
          <div>
            ...
            <ul className='flex flex-col gap-2 '>
              <li><a href="#" className='hover:bg-gray-300 transition duration-300 py-2 pr-1 rounded-sm nav-link' onClick={() =>setTradingToggle(false)}>Standard Account</a></li>
              <li><a href="#" className='hover:bg-gray-300 transition duration-300 py-2 pr-1 rounded-sm nav-link' onClick={() =>setTradingToggle(false)}>Highness Account</a></li>
              <li><a href="#" className='hover:bg-gray-300 transition duration-300 py-2 pr-1 rounded-sm nav-link' onClick={() =>setTradingToggle(false)}>Professional Account</a></li>
            </ul>
          </div>
          <div>
 ...
 <div className="relative inline-block text-slate-900">
     ...
     {isOpen && (
        ...
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded p-10 menu-btn" ><FiMenu/></button>
